...
Pogitive likelilood ratio<sup>2</sup> | `preg_pos_lr` | @simel1991
...
If you want to contribute code, please feel free to fork the repository, make your changes and make a pull request to have them integrated into the package.  New functionality should have accompanying tests and pass continuous integration. See also the [contributing guidelines]{https://github.com/CTU-Bern/presize/CONTRIBUTING.md}.
...
```{r, echo=FALSE}
knitr::include_graphics("man/figures/SCTO_Platform_Logo_2020_RZ_SM.png")
```
